...
import { createPaginationTokens } from "../lib/create-pagination-tokens";
...
export function CollectionPagination({ disabled = false, onPageChange, onPageSizeChange, page, pageSize, pageSizeOptions = [10, 20, 50], totalPages }: CollectionPaginationProps) {
